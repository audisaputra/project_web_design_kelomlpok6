    ...
    <div class="collapse navbar-collapse" id="navbarLinks">
      <ul class="navbar-nav">
        ...
        <li class="nav-item @service">
          <a class="nav-link" href="service.blade.php">Service</a>
        </li>
        ...
        <li class="nav-item @appointment">
          <a class="nav-link" href="appointment.blade.php">Appointment</a>
        </li>
...
<!--End Main Header --><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/medical-laravel/resources/views/layouts/header.blade.php ENDPATH**/ ?>