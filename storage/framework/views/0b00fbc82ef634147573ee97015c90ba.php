      ...
      <div class="row">
        <div class="col-12">
          ...
          <div class="content style text-center">
            ...
            <a href="about.blade.php" class="btn btn-main btn-white" data-animation-in="slideInLeft" data-duration-in="1.2">explore</a>
          </div>
          <!-- Slide Content End -->
        </div>
      </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/medical-laravel/resources/views/index.blade.php ENDPATH**/ ?>